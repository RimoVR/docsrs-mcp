...
def check_documentation_needs(session_data):
    ...
    task_keywords = ['implement', 'create', 'add', 'fix', 'refactor', 'update', 'complete']
    architecture_keywords = ['component', 'module', 'service', 'api', 'struct', 'trait', 'class']
...
def main():
    ...
    if needs_update:
        ...
        medium_priority = [item for item in needs_update if item['priority'] == 'medium']
