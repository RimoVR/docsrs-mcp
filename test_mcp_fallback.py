...
from docsrs_mcp.database import get_db_path
...
async def test_search_fallback_data():
    ...
    try:
        ...
        # Search
        results = await search_embeddings(db_path, query_embedding, k=3)
        ...
        if results:
            ...
            logger.info(
                "No search results found (this might be normal for fallback data)"
            )
