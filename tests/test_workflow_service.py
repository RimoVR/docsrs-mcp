...
class TestUsagePatternExtraction:
    ...
    async def test_pattern_categorization(self, workflow_service):
        ...
        assert workflow_service._categorize_pattern("impl Trait for Type") == "trait_implementation"
...
class TestLearningPathGeneration:
    ...
    async def test_migration_path(self, workflow_service):
        ...
        with patch("docsrs_mcp.services.workflow_service.get_diff_engine") as mock_get_engine:
...
class TestCaching:
    ...
    async def test_pattern_cache(self, workflow_service):
        ...
        cached_patterns = [
            {"pattern": "test.method()", "frequency": 10}
        ]
