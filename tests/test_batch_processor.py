...
class TestBatchProcessor:
    ...
    def test_batch_processor_with_items(self):
        ...
        results = list(
            processor.process_batch(items, process_func, batch_size_override=3)
        )
    ...
    def test_operation_specific_batch_sizes(self):
        ...
        with patch(
            "docsrs_mcp.batch_processor.get_adaptive_batch_size", return_value=500
        ):
            size = processor._calculate_batch_size()
            assert size == 500
    ...
    def test_cleanup_after_batch(self):
        ...
        with patch("gc.collect") as mock_gc:
            ...
            list(
                processor.process_batch(items, lambda b: len(b), batch_size_override=2)
            )
