            ...
            MCPTool(
                ...
                input_schema={
                    ...
                    "properties": {
                        ...
                        "has_examples": {
                            "type": "string",
                            "description": "Filter to only items with code examples (pass as string: 'true' or 'false')",
                            "examples": ["true", "false"],
                        },
                        "min_doc_length": {
                            "type": "string",
            ...
            MCPTool(
                ...
                input_schema={
                    ...
                    "properties": {
                        ...
                        "k": {
                            "type": "string",
                            "description": "Number of examples to return (pass as string: '5', '10', '15')",
                            "default": "5",
                            "examples": ["5", "10", "15", "20"],
                        },
                        "language": {
                ...
                input_schema={
                    ...
                    "properties": {
                        "force": {
                            "type": "string",
                            "default": "false",
                            "description": "Force restart if pre-ingestion is already running (pass as string: 'true' or 'false')",
                            "examples": ["true", "false"],
                        },
                        "concurrency": {
                            "type": "string",
                            "description": "Number of parallel download workers (pass as string: '1' to '10', default: '3')",
                            "default": "3",
                            "examples": ["3", "5", "8", "10"],
                        },
                        "count": {
                            "type": "string",
                            "description": "Number of crates to pre-ingest (pass as string: '10' to '500', default: '100')",
                            "default": "100",
                ...
                input_schema={
                    ...
                    "properties": {
                        ...
                        "concurrency": {
                            "type": "string",
                            "default": "3",
                            "description": "Number of parallel download workers (pass as string: '1' to '10')",
                            "examples": ["3", "5", "8", "10"],
                        },
                        "skip_existing": {
                            "type": "string",
                            "default": "true",
                            "description": "Skip already ingested crates (pass as string: 'true' or 'false')",
                            "examples": ["true", "false"],
                        },
                        "resolve_versions": {
                            "type": "string",
                            "default": "false",
                            "description": "Resolve version specifications to concrete versions (pass as string: 'true' or 'false')",
                            "examples": ["true", "false"],
                        },
                    },
                    "required": ["file_path"],
                ...
                input_schema={
                    ...
                    "properties": {
                        ...
                        "include_unchanged": {
                            "type": "string",
                            "default": "false",
                            "description": "Include unchanged items in response (pass as string: 'true' or 'false')",
                            "examples": ["true", "false"],
                        },
                        "categories": {
                            "type": "array",
                        ...
                        "max_results": {
                            "type": "string",
                            "default": "1000",
                            "description": "Maximum number of changes to return (pass as string: '100' to '5000')",
